...
public class user_regActivity extends Activity {
    TextView brand;
...
//                    mpref = getSharedPreferences("User", MODE_PRIVATE);
                        ...
                        umobile = mobiletext.getText().toString().trim();
//                    Log.d("Error 2", "error");
                        Toasty.info(user_regActivity.this, "Mobile No: " + umobile + " And Email ID: " +
...
//                                    Toast.makeText(addclient_activity.this, "Client Added To Database...", Toast.LENGTH_LONG).show();
                                        ...
                                        Toasty.success(user_regActivity.this, "User Data Updated Successfuly",
                                                Toast.LENGTH_LONG, true).show();
                                        startActivity(new Intent(user_regActivity.this, splash.class));
                                        finish();
                                    }
    ...
    protected boolean isOnline() {
        ...
        Toasty.error(mcontext,"Network Info: "+isConnected,10).show();
        return isConnected;
    }
}
