...
public class diary_adapter extends FirestoreRecyclerAdapter<diarycard_gen, diary_adapter.diary_holder> {
    ...
    public diary_adapter(@NonNull FirestoreRecyclerOptions<diarycard_gen> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull diary_holder holder, int position, @NonNull final diarycard_gen model) {
        int x = position + 1;
