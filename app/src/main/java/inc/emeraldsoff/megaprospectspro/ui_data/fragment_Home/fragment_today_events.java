...
public class fragment_today_events extends Fragment {
...
//        setRetainInstance(true);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new fragment_birthdays_today(), "Birthdays");
        adapter.addFragment(new fragment_anniversaries_today(), "Anniversaries");
